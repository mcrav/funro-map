...
export const CookiePopup = () => {
  ...
  return (
    <div className="fixed bottom-4 left-0 right-0 mx-auto mb-3 w-3/4 items-center rounded-lg bg-slate-100 p-5 text-center shadow-lg">
      <P>
        We use cookies just to understand how many people visit the site. No
        weird stuff.{" "}
